...
namespace QboxNext.ConsoleApp
{
    ...
    public class ConsoleHostBuilder : HostBuilder
    {
        ...
        /// <summary>
        /// Add command line parser with provided args. Use in conjunction with <see cref="HostExtensions.RunWithArgumentsAsync{TCommandLineOptions}" />.
        /// </summary>
        ...
        /// <param name="args">The raw command line argument values.</param>
        /// <returns>The builder instance.</returns>
        public ConsoleHostBuilder ParseArguments<TCommandLineOptions>(Parser parser, params string[] args)
            where TCommandLineOptions : class, new()
        {
            ConfigureServices((context, services) =>
            {
                ParserResult<TCommandLineOptions> parserResult = parser
                    .ParseArguments<TCommandLineOptions>(args)
                    .WithParsed(options =>
                    {
